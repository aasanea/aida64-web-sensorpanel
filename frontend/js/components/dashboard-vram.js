...
<div class="card-header">
  <div class="card-title-group">
    ...
    <div>
      <h2 class="card-title">ذاكرة الفيديو</h2>
      <span class="card-sub">GPU VRAM</span>
    </div>
  </div>
</div>
...
<div class="card-body-medium">
  ...
  <div class="capacity-row">
    ...
    <div class="capacity-val-group">
      <span class="cap-val" id="vram_used_gb">--</span>
      <span class="cap-separator">/</span>
      <span class="cap-total" id="vram_total_gb">--</span>
  ...
  <div class="card-sub-grid">
    <div class="sub-stat-box">
      <span class="arabic-label">تردد VRAM</span>
      <div class="sub-stat-val">
        <span class="sub-num" id="vram_speed_mhz">--</span>
        <span class="sub-unit">MHz</span>
      </div>
    </div>
    <div class="sub-stat-box">
      <span class="arabic-label">حرارة VRAM</span>
      <div class="sub-stat-val">
        <span class="sub-num" id="vram_temp">--</span>
  ...
  <div class="metric-row">
    ...
    <div class="progress-track">
      <div class="progress-bar" id="vram_used_percent_bar" style="width: 0%;">
...
export class DashboardVRAM extends HTMLElement {
  constructor() {
    super();
  ...
  render() {
    this.updateText(this.dom.vram_used_percent, this.currentValues.vram_used_percent, 0);
    ...
    this.updateText(this.dom.vram_speed_mhz, this.currentValues.vram_speed_mhz, 0);
    this.updateText(this.dom.vram_temp, this.currentValues.vram_temp, 0);
...
customElements.define('dashboard-vram', DashboardVRAM);
